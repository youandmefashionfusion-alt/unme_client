...
const ProductCardStatement = ({ product }) => {
  ...
  return (
    <>
      <div
        className="group relative bg-white border rounded-lg overflow-hidden transition hover:shadow-lg h-full flex flex-col" onMouseEnter={() => setIsHovered(true)}
      ...
      >
        ...
        <button
          ...
          className="absolute top-12 right-2 z-10 bg-white rounded-full p-2 shadow hover:bg-gray-100"
        >
          <Eye size={16} />
        </button>
        ...
        <div className="p-4 space-y-2 flex flex-col flex-grow">
          <h3
            onClick={handleNavigateToProduct}
            className="text-sm font-medium line-clamp-2 h-10 cursor-pointer"
          >
            {product?.title}
          </h3>
          ...
          <div className="flex items-center gap-1 text-yellow-500 text-sm min-h-[20px]">
...
export default React.memo(ProductCardStatement);
